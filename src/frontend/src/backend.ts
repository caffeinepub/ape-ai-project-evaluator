...
import type { Evaluation as _Evaluation, Project as _Project, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async getAllEvaluations(): Promise<Array<Evaluation>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAllEvaluations();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getEvaluation(arg0: bigint): Promise<Evaluation | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getEvaluation(arg0);
    ...
    async submitProject(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string, arg5: Array<string>): Promise<bigint> {
        if (this.processError) {
            try {
    ...
    async triggerEvaluation(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.triggerEvaluation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_opt_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Evaluation]): Evaluation | null {
    return value.length === 0 ? null : value[0];
}
function from_candid_opt_n17(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_Project]): Project | null {
...
function from_candid_variant_n16(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    failed: null;
}): Variant_evaluated_pending_evaluating_failed {
    return "evaluated" in value ? Variant_evaluated_pending_evaluating_failed.evaluated : "pending" in value ? Variant_evaluated_pending_evaluating_failed.pending : "evaluating" in value ? Variant_evaluated_pending_evaluating_failed.evaluating : "failed" in value ? Variant_evaluated_pending_evaluating_failed.failed : value;
}
